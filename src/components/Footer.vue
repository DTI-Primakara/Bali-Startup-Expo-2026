<template>
  <footer class="w-full md:pt-25 p-10 gap-4 bg-white flex flex-col items-center">
    <div
    ...
    >
      ...
      >
        ...
        <a href="#activity"><p>Activity</p></a>
        <a href="#side-event"><p>Side Event</p></a>
    ...
    <hr class="text-[#031446] w-full border" />
    <p class="md:text-xl text-base font-semibold text-black text-center">
      © 2026 Bali Startup Expo. All rights reserved.
    </p>
  </footer>
</template>
